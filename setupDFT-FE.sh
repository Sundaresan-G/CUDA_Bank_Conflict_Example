...
spack load nccl gcc@11.3.0 cuda@11.7.0 boost@1.76.0 intel-oneapi-mkl@2022.1.0 cmake@3.23.1 ninja openmpi@4.1.6%gcc@11.3.0
...
cxx_flagsRelease="-O2 -funroll-loops -ftree-vectorize" #sets DCMAKE_CXX_FLAGS_RELEASE
...
function cmake_real() {
  ...
  if [ "$gpuLang" = "cuda" ]; then
    ...
    -DWITH_DCCL=$withDCCL -DCMAKE_PREFIX_PATH="$ELPA_PATH;$DCCL_PATH;$numdiffdir;$dftdpath"\
